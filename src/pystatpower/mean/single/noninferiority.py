...
"""Power analysis for the non-inferiority test of a single mean.
...
- mean difference
- non-inferiority mean threshold
- offset
- standard deviation
"""
...
class _ParamsValidator:
    ...
    def _validate_against_noninferiority_mean(self, *, warning: bool = True) -> None:
        ...
        if self.noninferiority_mean is None:
            msg = "The non-inferiority mean cannot be calculated using the specified combination of parameters. Please provide the 'noninferiority_mean' parameter directly, or use both 'null_mean' and 'margin'."
            raise ValueError(msg)
...
def solve_noninferiority_mean(
    *,
    ...
    r"""Estimate the required non-inferiority mean.
