...
def solve_proportion(
    *,
    ...
    match alternative:
        case "greater":
            return float(brentq(func, null_proportion + margin + eps, 1 - eps))
        case "less":
            return float(brentq(func, eps, null_proportion + margin - eps))
...
def solve_margin(
    *,
    ...
    match alternative:
        case "greater":
            return float(brentq(func, eps, proportion - null_proportion - eps))
        case "less":
            return float(brentq(func, proportion - null_proportion + eps, -eps))
